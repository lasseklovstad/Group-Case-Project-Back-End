...
public interface TeamRepository extends JpaRepository<Team, Integer> {
	...
	@Query(value = "SELECT  t.teamId, t.name, t.coach.coachId, CONCAT(t.coach.person.firstName,' ',t.coach.person.lastName), t.location.locationId, t.location.name,t.location.locationId, t.location.address.country FROM Team t")
